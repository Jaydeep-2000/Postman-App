...
submit.addEventListener('click', () => {
    //show please wait in in the response box to request patience from the user
    ...
    //    If the user has used params option insted of json collect all the parameters in an object
